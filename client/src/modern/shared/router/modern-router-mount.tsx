...
// Initialise l'i18n du front neuf (react-i18next) AVANT le premier rendu du sous-arbre modern.
import "../i18n";

// Point de montage du routeur neuf DANS l'arbre React legacy : il est rendu sous la route wouter
// `/*` (cf. App.tsx), donc à l'intérieur des providers déjà en place (QueryClient + tRPC + auth +
// DashboardLayout). À partir de là, TanStack Router gère toute la navigation sous `/*` (basepath).
