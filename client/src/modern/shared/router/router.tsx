...
const clientsNouveauRoute = createRoute({ getParentRoute: () => rootRoute, path: "/clients/nouveau", component: lazyRouteComponent(() => import("../../features/client-form/ui/clients-nouveau-page")) });
const clientsImportRoute = createRoute({ getParentRoute: () => rootRoute, path: "/clients/import", component: lazyRouteComponent(() => import("../../features/clients-import/ui/clients-import-page")) });
const mobileRoute = createRoute({ getParentRoute: () => rootRoute, path: "/mobile", component: lazyRouteComponent(() => import("../../features/interventions-mobile/ui/interventions-mobile-page")) });
const commandeDetailRoute = createRoute({ getParentRoute: () => rootRoute, path: "/commandes/$id", component: lazyRouteComponent(() => import("../../features/commande-detail/ui/commande-detail-page")) });
const contratDetailRoute = createRoute({ getParentRoute: () => rootRoute, path: "/contrats/$id", component: lazyRouteComponent(() => import("../../features/contrat-detail/ui/contrat-detail-page")) });
const profilRoute = createRoute({ getParentRoute: () => rootRoute, path: "/profil", component: lazyRouteComponent(() => import("../../features/profil/ui/profil-page")) });
const devisLigneRoute = createRoute({ getParentRoute: () => rootRoute, path: "/devis/$id/ligne/nouvelle", component: lazyRouteComponent(() => import("../../features/devis-ligne/ui/devis-ligne-page")) });
const devisNouveauRoute = createRoute({ getParentRoute: () => rootRoute, path: "/devis/nouveau", component: lazyRouteComponent(() => import("../../features/devis-nouveau/ui/devis-nouveau-page")) });
const devisDetailRoute = createRoute({ getParentRoute: () => rootRoute, path: "/devis/$id", component: lazyRouteComponent(() => import("../../features/devis-detail/ui/devis-detail-page")) });
const factureDetailRoute = createRoute({ getParentRoute: () => rootRoute, path: "/factures/$id", component: lazyRouteComponent(() => import("../../features/facture-detail/ui/facture-detail-page")) });
const commandeNouvelleRoute = createRoute({ getParentRoute: () => rootRoute, path: "/commandes/nouvelle", component: lazyRouteComponent(() => import("../../features/commande-form/ui/commande-form-page")) });
const commandeModifierRoute = createRoute({ getParentRoute: () => rootRoute, path: "/commandes/$id/modifier", component: lazyRouteComponent(() => import("../../features/commande-form/ui/commande-form-page")) });
