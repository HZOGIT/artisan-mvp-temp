...
// L3 e2e (HTTP → tRPC `rapports.*`) : rapports personnalisables du tenant (protégés).
describe.skipIf(!URL)("rapports.router e2e (protégé)", () => {
  ...
  beforeAll(async () => {
    ...
    await admin.query('insert into artisans ("userId","nomEntreprise") values ($1,$2)', [UID, "Rapports SARL"]);
