...
describe("app Fastify (scaffold + tRPC)", () => {
  ...
  const sampleProcedure: Record<string, string> = { vehicules: "vehicules.list", avis: "avis.list", badges: "badges.list", techniciens: "techniciens.list", notifications: "notifications.list", fournisseurs: "fournisseurs.list", commandes: "commandes.list", stocks: "stocks.list", clients: "clients.list", interventions: "interventions.list", conges: "conges.list", notesDeFrais: "notesDeFrais.list", chantiers: "chantiers.list", depenses: "depenses.list", devis: "devis.list", factures: "factures.list", ecritures: "ecritures.list", articles: "articles.list", parametres: "parametres.get", modelesEmail: "modelesEmail.list", modelesDevis: "modelesDevis.list", configRelances: "configRelances.get", rdvEnLigne: "rdvEnLigne.list", relancesDevis: "relancesDevis.list", categoriesDepenses: "categoriesDepenses.list", contratsMaintenance: "contratsMaintenance.list", demandesContact: "demandesContact.list", budgetsCategories: "budgetsCategories.list", reglesCategorisation: "reglesCategorisation.list", previsionsCA: "previsionsCA.list" };
