...
import type { ArtisanReader, ArtisanInfo } from "../application/artisan-reader";

/*
 * Lecture de l'artisan émetteur (tenant courant) pour l'email + le PDF bon de commande. Renvoie la
 * ligne brute `artisans` (transmise au générateur PDF legacy) ; scopée par `ctx.artisanId` (RLS).
 */
