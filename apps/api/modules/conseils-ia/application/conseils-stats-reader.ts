 ...
 * - devis en attente = statut ∈ {brouillon, envoye} ; factures impayées = typeDocument = facture ET
 *   statut ∉ {payee, annulee, brouillon} (count + somme totalTTC, avoirs exclus — parité computeEncoursSummary frontend) ;
 *   stocks bas = quantiteEnStock ≤ seuilAlerte.
 */
