...
function toProfile(r: Row): ArtisanProfile {
  return {
    ...
    assuranceDecennaleNom: r.assuranceDecennaleNom ?? null,
    assuranceDecennalePolice: r.assuranceDecennalePolice ?? null,
    assuranceDecennaleGarantie: r.assuranceDecennaleGarantie ?? null,
    stripeConnectAccountId: r.stripeConnectAccountId ?? null,
    stripeConnectChargesEnabled: r.stripeConnectChargesEnabled ?? false,
    stripeConnectPayoutsEnabled: r.stripeConnectPayoutsEnabled ?? false,
    stripeConnectDetailsSubmitted: r.stripeConnectDetailsSubmitted ?? false,
    stripeConnectRequirements: r.stripeConnectRequirements ?? null,
    stripeConnectStatus: r.stripeConnectStatus ?? "none",
    stripeConnectConnectedAt: r.stripeConnectConnectedAt ?? null,
    stripeConnectUpdatedAt: r.stripeConnectUpdatedAt ?? null,
