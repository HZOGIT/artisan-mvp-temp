...
export interface PortalPaymentReader {
  ...
  /** Retourne un paiement déjà capturé (statut payee) pour cette facture, ou null. Garde idempotence cross-webhook. */
  getPaiementPaye(ctx: TenantContext, factureId: number): Promise<{ id: number } | null>;
