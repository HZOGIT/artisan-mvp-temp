...
## 🎯 PROCHAINE CIBLE : **Portail slice 3** — onglets Interventions (`getInterventions`) + Suivi chantiers (`getSuiviChantiers` + Progress). Puis slices 4-6 (rdv / chat / demande IA). Plan complet ci-dessous.
