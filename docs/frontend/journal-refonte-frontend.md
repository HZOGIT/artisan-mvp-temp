...
## 🎯 PROCHAINE CIBLE : **Portail slice 5** — onglet Messages/Chat (`getConversations` + `getConversationMessages` + `sendClientMessage`, liste convs + thread + envoi, `skipToken` + poll). Puis slice 6 (Demande IA) + Home.
