...
- **LONGUE TRAÎNE** (stratégie de progression régulière, faible risque) : il reste de NOMBREUSES petites
  ...
  `flotte`, `statistiques-devis`, `modules`. **Restantes** : NotesFrais, Conges, Calendrier, Contrats,
  RelancesDevis, DevisOptions, Utilisateurs, Parametres → prochaine cible longue traîne au choix.
