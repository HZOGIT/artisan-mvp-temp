...
- **LONGUE TRAÎNE** (stratégie de progression régulière, faible risque) : il reste de NOMBREUSES petites
  ...
  `flotte`, `statistiques-devis`, `modules`, `conges`, `contrats`, `relances-devis`. **Restantes** :
  Calendrier, DevisOptions, Utilisateurs, Parametres → prochaine cible longue traîne au choix.
