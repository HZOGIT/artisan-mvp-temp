...
## 🎯 PROCHAINE CIBLE : **Portail slice 2** — onglets Devis (`getDevis`) + Factures (`getFactures` + **paiement Stripe** REST `/api/paiement/create-checkout-session`). Puis slices 3-6 (interventions+chantiers / rdv / chat / demande IA). Plan complet ci-dessous.
