...
## 🎯 PROCHAINE CIBLE : **Home marketing (`/`)** — porter la dernière page legacy (statique, 0 endpoint, gros i18n) en `/v2` clean-archi, puis enchaîner cutover + bascule v2-défaut + suppression legacy (cf. « ETA GLOBAL »).
