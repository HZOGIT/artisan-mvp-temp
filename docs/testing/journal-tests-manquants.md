...
**Routeurs L3 faits (it.27-39)** : artisan, utilisateurs, devices, comptabilite, dashboard, statistiques, search, chat, calendrier, rapports, emails, activites, **feature-modules** ✅ it.39.
**Prochaine cible : `geolocalisation` — L3 `geolocalisation.router.test.ts`**. Puis le reste (alertes-previsions, assistant, conseils-ia, devis-ia, devis-options, import-erp, integrations-comptables, interventions-mobile, support, vitrine).
