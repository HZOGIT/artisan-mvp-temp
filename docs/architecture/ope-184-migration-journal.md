...
**Prochaine action : P0.7d-3** (gamification : `verifierEtAttribuerBadges` ~L5661, `calculerClassement` ~L5723). Puis 7d-4 push (savePushSubscription), 7d-5 alertes (saveConfigAlertePrevision, verifierEcartsEtEnvoyerAlertes). Puis P0.8 (copie data staging) + P0.9 (tests sur PG) avant cutover.
