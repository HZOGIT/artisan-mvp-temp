...
**Prochaine action : P0.7d-7** (onboarding : `updateArtisanOnboarding` ~L4516, `getArtisanOnboardingStatus` ~L4548). Puis 7d-8 subscriptions (billing — ⚠️ vérifier intégrité Stripe), 7d-9 devices, 7d-10 sessions, 7d-11 getDashboardStats. Puis routers.ts/index.ts. Puis P0.8 (copie data) + P0.9 (tests PG) avant cutover.
