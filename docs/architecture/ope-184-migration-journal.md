...
**Prochaine action : P0.7c-6d** (`exportDepensesFEC` ~L7560 + `getDeclarationTVADetail` ~L3343, 3 raw SQL — TVA collectée/déductible/à payer ; vérifier cohérence TVA). Puis 7c-7 (banque : getTransactionsBancaires, getTresoreriePrevisionnelle, importReleve, ignorerTransaction, lierTransactionDepense).
