...
**Prochaine action : P0.7d-9** (devices : `getDevices`/`getDevice`/`registerDevice`/`countActiveDevices`/`deleteDevice`/`deleteOtherDevices` ~L4742-4825, table `devices` pg). Puis 7d-10 sessions (5 fn), 7d-11 getDashboardStats. Puis routers.ts/index.ts. Puis P0.8 (copie data) + P0.9 (tests PG) avant cutover.
