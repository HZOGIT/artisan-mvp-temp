...
**Prochaine action : P0.7d-4** (push : `savePushSubscription` ~L6677, upsert endpoint). Puis 7d-5 alertes (`saveConfigAlertePrevision`, `verifierEcartsEtEnvoyerAlertes`). Puis P0.8 (copie data staging) + P0.9 (tests sur PG) avant cutover.
